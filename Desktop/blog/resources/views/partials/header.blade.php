    ...
    <div class="sidebar-menu">
        ...
        <ul class="menu-list">
            <li class="menu-item-has-children active">
                <a href="index.html" class="drop-down">DEMO</a><i class="bi bi-plus dropdown-icon"></i>
                <ul class="sub-menu">
                    <li><a href="index.html">Life Style</a></li>
                    <li><a href="travel/index.html">Travel</a></li>
                    <li><a href="pet-care/index.html">Pet Care</a></li>
                    <li><a href="health-and-wellness/index.html">Health & Wellness</a></li>
                    <li><a href="ai-technology/index.html">AI Technology</a></li>
                    <li><a href="podcast/index.html">Podcast</a></li>
                    <li><a href="minimal.html">Minimal</a></li>
                </ul>
            </li>
            <li><a href="life-style.html">LIFE STYLE</a></li>
            <li><a href="life-style.html">FOOD</a></li>
            <li><a href="life-style.html">TRAVEL</a></li>
            <li><a href="life-style.html">GAMING</a></li>
            <li class="menu-item-has-children">
                <a href="#" class="drop-down">POST FEATURES</a><i class="bi bi-plus dropdown-icon"></i>
                <ul class="sub-menu">
                    ...
                    <li>
                        ...
                        <i class="bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                            <li><a href="full-widht-with-sideber.html">Full Width with sidebar</a></li>
                            <li><a href="full-widht-with-no-sidebar.html">Full Width No sidebar</a></li>
                            ...
                            <li><a href="vertical-with-no-sidebar.html">Vertical with No Sidebar</a></li>
                        </ul>
                    </li>
        ...
        <div class="menu-bottom-content">
            <div class="subscribe-area">
                ...
                <a href="#" class="primary-btn hover-btn">SUBSCRIBE
            ...
            <div class="header-menu-icon">
                <div class="menu-icon">
                    <svg width="20" height="20" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.66675 9.16666H18.3334V10.8333H1.66675V9.16666ZM1.66675 4.16666H18.3334V5.83332H1.66675V4.16666ZM1.66675 14.1667H18.3334V15.8333H1.66675V14.1667Z"></path>
                    </svg>
                </div>
                    ...
                    <div class="search-input">
                        ...
                        <form>
                            ...
                            <div class="quick-search">
                                <ul>
                                    <li>Quick Search :</li>
                                    <li><a href="life-style.html">Beauty,</a></li>
                                    <li><a href="life-style.html">Gaming Tips,</a></li>
                                    <li><a href="life-style.html">Fashion,</a></li>
                                    <li><a href="life-style.html">Tech,</a></li>
                                </ul>
                            </div>
                        </form>
                    </div>
                ...
                <div class="subscribe-btn ">
                    <a href="#" class="primary-btn hover-btn">
                        <svg class="arrow" width="11" height="11" viewbox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0.999756 10L9.99976 1M9.99976 1C7.99976 1.375 3.62476 2.125 0.999756 1M9.99976 1C9.62476 2.875 8.87476 7 9.99976 10" stroke="#191919" stroke-width="1.5" stroke-linecap="round"></path>
                        </svg>
                        SUBSCRIBE
                    </a>
